/*Sistema de proformas de una tienda de autos
En este sistema solo tienen acceso los empleados y el jefe.
En este sistema existen  dos opciones

la primera opcion solo puede ingresar el jefe con una contraseña
seguido de eso se le muestra la lista de sus empleado
el jefe selecciona a uno de ellos y los evalua segun la cantidad de autos que vendio
suma su sueldo mensual mas las comisiones por ventas
y se exporta en un txt reporte de lo que genero el empleados durante el mes.

la segunda opcion puede acceder el empleado para hacer una proforma
empieza solcitando el codigo de empleado 
y luego hace un registro de datos de cliente;
seguido de eso sale un menu indicando las marcas de los vehiculos
y una vez seleccionado una marca se muestre una lista de los modelos de esa marca,
luego con todo esos datos, exportamos en un txt con la proforma del auto seleccionada
*/
#include <iostream>
#include <fstream>
#include <iomanip>
    ...
    if (accion == 1)
    {
        ...
        if (contra1 == contra2)
        {
            ...
            if (selec_empleado == 1)
            {
                ...
                archivo << right << setw(41) << "__________\n";
                archivo << left << setw(30) << "Ganancia Total: ";
                archivo << setw(3) << "s/ ";
                archivo << right << setw(7) << suma << "\n";

                archivo << " ___________________________________________\n";
                archivo << "|											|\n";
